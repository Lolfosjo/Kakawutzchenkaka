...
use muqsit\vanillagenerator\generator\overworld\decorator\ConeflowerDecorator;
use muqsit\vanillagenerator\generator\overworld\decorator\CustomRockDecorator;
use muqsit\vanillagenerator\generator\overworld\decorator\DeadBushDecorator;
use muqsit\vanillagenerator\generator\overworld\decorator\DesertGrassDecorator;
...
use muqsit\vanillagenerator\generator\overworld\decorator\FallenBirchDecorator;
use muqsit\vanillagenerator\generator\overworld\decorator\FallenLeavesDecorator;
...
use muqsit\vanillagenerator\generator\overworld\decorator\SukkulentenPflanzeDecorator;
...
use muqsit\vanillagenerator\generator\overworld\decorator\VanillaBushDecorator;
...
class BiomePopulator implements Populator{
	...
	protected SukkulentenPflanzeDecorator $sukkulenten_decorator;
	protected VanillaBushDecorator $vanilla_bush_decorator;
	protected DesertGrassDecorator $desert_grass_decorator;
	protected FallenBirchDecorator $fallen_birch_decorator;
    protected FallenLeavesDecorator $fallen_leaves_decorator;
	protected CustomRockDecorator $custom_rock_decorator;
	protected ConeflowerDecorator $coneflower_decorator;
	...
	public function __construct(){
		...
		$this->vanilla_bush_decorator = new VanillaBushDecorator();
		$this->desert_grass_decorator = new DesertGrassDecorator();
		$this->sukkulenten_decorator = new SukkulentenPflanzeDecorator();
		...
		$this->fallen_birch_decorator = new FallenBirchDecorator();
		$this->fallen_leaves_decorator = new FallenLeavesDecorator();
		$this->custom_rock_decorator = new CustomRockDecorator();
		$this->coneflower_decorator = new ConeflowerDecorator();
		...
		array_push($this->on_ground_populators,
			...
			$this->sukkulenten_decorator,
			$this->vanilla_bush_decorator,
			$this->desert_grass_decorator,
			$this->fallen_birch_decorator,
			$this->fallen_leaves_decorator,
			$this->custom_rock_decorator,
			$this->coneflower_decorator
		);
	...
	protected function initPopulators() : void{
		...
		$this->sukkulenten_decorator->setAmount(1);
		$this->vanilla_bush_decorator->setAmount(2);
		$this->desert_grass_decorator->setAmount(1);
		$this->fallen_birch_decorator->setAmount(0);
		$this->fallen_leaves_decorator->setAmount(0);
		$this->custom_rock_decorator->setAmount(0);
		$this->coneflower_decorator->setAmount(0);
	}
