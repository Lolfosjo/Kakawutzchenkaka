...
use muqsit\vanillagenerator\generator\overworld\populator\biome\BeachPopulator;
...
use muqsit\vanillagenerator\generator\overworld\populator\biome\MesaPopulator;
...
class OverworldPopulator implements Populator{
	...
	public function __construct(){
		...
		$this->registerBiomePopulator(new BeachPopulator());
		/*
